...
export function EmployeeSidebar({ holidayStats, onEditProfile, className }: EmployeeSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <div className={cn(
        "lg:hidden fixed inset-y-0 left-0 w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 overflow-y-auto overscroll-contain",
